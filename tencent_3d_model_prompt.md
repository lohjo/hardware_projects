...
face to its flat top face is **16.0 mm**. All external corners carry a **1.0 mm chamfer** (not
a radius — a flat 45-degree cut) to prevent stress concentration during press-fit assembly
and to give the part a machined, professional appearance when rendered.
